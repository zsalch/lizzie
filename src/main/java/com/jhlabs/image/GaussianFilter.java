...
/**
 * A filter which applies Gaussian blur to an image. This is a subclass of ConvolveFilter which
 * simply creates a kernel with a Gaussian distribution for blurring.
 *
...
public class GaussianFilter extends ConvolveFilter {
  ...
  /**
   * Set the radius of the kernel, and hence the amount of blur. The bigger the radius, the longer
   * this filter will take.
   *
